...
```gradle
dependencies {
    implementation 'at.bluesource.choicesdk:choicesdk-analytics:0.1.1'
    implementation 'at.bluesource.choicesdk:choicesdk-location:0.1.1'
    implementation 'at.bluesource.choicesdk:choicesdk-maps:0.1.1'
    implementation 'at.bluesource.choicesdk:choicesdk-messaging:0.1.1'
    implementation 'at.bluesource.choicesdk:choicesdk-signin:0.1.1'
}
```
