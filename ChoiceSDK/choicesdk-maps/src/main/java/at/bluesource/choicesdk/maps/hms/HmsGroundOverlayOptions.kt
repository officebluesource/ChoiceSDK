...
/**
 * Wrapper class for hms version of GroundOverlayOptions
 *
 * @property groundOverlayOptions hms groundOverlayOptions instance
 * @see com.huawei.hms.maps.model.GroundOverlayOptions
 */
internal class HmsGroundOverlayOptions(private val groundOverlayOptions: com.huawei.hms.maps.model.GroundOverlayOptions) :
    ...
    override fun image(bitmapDescriptor: BitmapDescriptor): GroundOverlayOptions {
        when (bitmapDescriptor) {
            is BitmapDescriptor.HmsBitmapDescriptor -> groundOverlayOptions.image(bitmapDescriptor.value)
    ...
    override fun position(location: LatLng, width: Float): GroundOverlayOptions {
        groundOverlayOptions.position(location.toHmsLatLng(), width)
        return this
    }

    override fun position(location: LatLng, width: Float, height: Float): GroundOverlayOptions {
        groundOverlayOptions.position(location.toHmsLatLng(), width, height)
        return this
    }

    override fun positionFromBounds(bounds: LatLngBounds): GroundOverlayOptions {
        groundOverlayOptions.positionFromBounds(bounds.toHmsLatLngBounds())
        return this
    }
    ...
    internal fun getGroundOverlayOptions(): com.huawei.hms.maps.model.GroundOverlayOptions {
